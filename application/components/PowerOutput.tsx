    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="my-3 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-xs text-gray-400 p-2 bg-gray-900/50 rounded-lg">
                <div className="flex items-center justify-center gap-1.5">
                    ...
                    <span className="truncate">Bulbo Seco: <strong className="text-white font-mono">{dryBulbTemp.toFixed(1)}°C</strong></span>
                </div>
                <div className="flex items-center justify-center gap-1.5">
                    <ThermometerIcon className="w-4 h-4 opacity-70" />
                    <span className="truncate">Bulbo Úmido: <strong className="text-white font-mono">{wetBulbTemp.toFixed(1)}°C</strong></span>
                </div>
                <div className="flex items-center justify-center gap-1.5">
            ...
            {isOnline && powerLoss > 0.1 && (
                <div className="p-3 bg-orange-900/50 border-l-4 border-orange-400 rounded-r-lg">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-orange-400 text-sm">Perda de Potência por Temperatura</p>
                            <p className="text-lg font-bold font-mono text-white">-{powerLoss.toFixed(1)} MW</p>
                        </div>
                    </div>
                    <p className="text-xs text-gray-400 mt-1 pl-9">
                       A alta temperatura ambiente reduz a densidade do ar, impactando a eficiência da turbina.
                    </p>
                </div>
            )}
        </div>
        ...
        <div className="mt-auto pt-2 border-t border-gray-700 grid grid-cols-3 text-center divide-x divide-gray-700">
          ...
          <div>
            <p className="text-sm text-gray-400">Ganho (Utilitários)</p>
            <p 
