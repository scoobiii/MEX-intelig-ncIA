...
const NuclearProjectAnalysis: React.FC<NuclearProjectAnalysisProps> = () => {
  const pageHtml = `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<strong>Complexidade:</strong> Maior</p>
  ...
  return (
    <DashboardCard title={'Análise de Projeto Nuclear (SMR)'} icon={<ActivityIcon className="w-6 h-6" />}>
