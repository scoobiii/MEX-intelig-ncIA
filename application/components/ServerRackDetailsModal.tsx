    ...
    if (active && payload && payload.length) {
      return (
        <div className="bg-gray-700 p-2 border border-gray-600 rounded-md shadow-lg">
          ...
          <p className="intro text-sm text-red-400">{`Temp: ${payload[0].value.toFixed(1)}°C`}</p>
        </div>
      );
    }
    return null;
...
const ServerRackDetailsModal: React.FC<ServerRackDetailsModalProps> = ({ rack, onClose }) => {
    if (!rack) return null;
            ...
            >
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="bg-gray-700 p-3 rounded-lg">
                                    <div className="flex justify-between items-baseline">
                                        <p className="text-sm text-gray-400">Entrada (Ingress)</p>
                                ...
                                <div className="bg-gray-700 p-3 rounded-lg">
                                    <div className="flex justify-between items-baseline">
                                        <p className="text-sm text-gray-400">Saída (Egress)</p>
                        ...
                        <div>
                            <h4 className="font-semibold text-gray-300 mb-2">Histórico de Temperatura</h4>
