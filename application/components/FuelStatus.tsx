...
const FuelStatus: React.FC<FuelStatusProps> = ({ 
  ...
  const fuelModesText = {
      [FuelMode.NaturalGas]: 'Gás Natural',
      [FuelMode.Ethanol]: 'Etanol',
      [FuelMode.Biodiesel]: 'Biodiesel',
      [FuelMode.FlexNGH2]: 'Flex (Gás Natural / Hidrogênio)',
      [FuelMode.FlexEthanolBiodiesel]: 'Flex (Etanol / Biodiesel)',
      [FuelMode.Nuclear]: 'Nuclear',
      [FuelMode.SolarBess]: 'Solar + BESS',
      [FuelMode.WindBess]: 'Eólica + BESS'
  };

  let fuelTitle: string = fuelModesText[fuelMode];
      ...
      <div>
          ...
          <div className="relative h-32 w-full flex items-center justify-center -mt-4">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-end pb-4 pointer-events-none">
              ...
              <p className="text-gray-400 text-xs -mt-1">Consumo (kg/s)</p>
            </div>
          </div>
      </div>
      ...
      <div className="mt-auto pt-4">
        {(showH2Slider || showBiodieselSlider) && (
          <div className="border-t border-gray-700 pt-3">
            <h4 className="text-sm font-semibold text-gray-400 mb-3 text-center">Ajuste do Mix Flexível</h4>
            {showH2Slider && (
              <div>
