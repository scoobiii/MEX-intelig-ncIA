...
import { ChatBubbleLeftRightIcon, PaperAirplaneIcon, XMarkIcon, CogIcon } from '../application/components/icons';
    ...
    const initializeChat = useCallback(() => {
        try {
            ...
            chatRef.current = ai.chats.create({
                ...
                config: {
                    systemInstruction: `You are IA, the helpful AI assistant for the MEX BioDataCloud platform. Your primary role is to provide clear, concise, and informative answers about the project in Portuguese (Brazil). You interact with a diverse audience, including developers, clients, investors, and students.
