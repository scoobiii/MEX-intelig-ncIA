...
import { SnowflakeIcon } from './application/components/icons';
        ...
        <div className="grid grid-rows-2 h-full gap-2">
            ...
            <div className="flex flex-col">
                <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400">Carga Atual (kW)</p>
                </div>
            ...
            <div className="flex flex-col border-t border-gray-700 pt-2">
                <div className="text-center">
                    ...
                    <p className="text-xs text-gray-400">Eficiência (kW/Ton)</p>
                </div>
                <div className="flex-grow h-10 mt-1 -mx-2">
                    <ResponsiveContainer width="100%" height="100%">
